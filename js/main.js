...
const Main = (() => {
      ...
      <div id="game-layout">
        ...
        <div id="panel-centre" class="window">
          ...
          <div class="window-body">
            ...
            <div id="system-log">
              <span class="log-line">GRIDHUB OMS v2.1 — session active</span>
              <span class="log-line">Awaiting operator input...</span>
            </div>
          </div>
        </div>
  ...
  function showSummary() {
    ...
    if (collapse) {
      tagLabel = 'SYSTEM COLLAPSE';   tagClass = 'collapse';
    } else if (rate.bracket === 'high') {
      tagLabel = 'AI DEPENDENCE';     tagClass = '';
    } else if (Object.values(vars).every(v => v >= 30)) {
      tagLabel = 'CONTROLLED RECOVERY'; tagClass = 'recovery';
    } else {
      tagLabel = 'STEADY MANAGEMENT'; tagClass = '';
    }
